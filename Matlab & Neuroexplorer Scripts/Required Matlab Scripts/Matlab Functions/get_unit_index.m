function [output_index,split_unit_name,split_data_type] = get_unit_index(unit_to_find,Q,DATA)
...
[split_unit_name, split_data_type ]  = split_unit_results_header(unit_to_find);
