...
fprintf('FINISHED.\n Next, run findOutliers_DATA_RawSpikes_SaveBins_CutLicks.m for full outlier removal workflow\n');
fprintf('OR if only want counts of unit responses: nexDATAcountUnitsFinal.m \n');
